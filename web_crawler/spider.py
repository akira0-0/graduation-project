...
# ==================== 配置中心 ====================
KEYWORDS = ["伊朗", "战机", "山河", "中国", "陈若琳", "豆瓣", "申请书", "霸王", "电影", "男子", "霍尔木兹海峡", "孟子", "向太怒", "A股", "春运", "流浪地球", "芯片", "数字货币", "新能源", "碳中和", "元宇宙", "短视频", "直播带货", "考研", "就业", "房价", "养老", "三孩政策", "教育减负", "网络安全", "大模型", "半导体", "量子计算", "可穿戴设备", "折叠屏", "自动驾驶", "深空探测", "探月工程", "火星", "空间站", "反腐", "一带一路", "乡村振兴", "低碳出行", "环保", "垃圾分类", "预制菜", "露营", "飞盘", "围炉煮茶", "淄博烧烤", "哈尔滨冰雪大世界", "马拉松", "健身房", "减脂", "预科生", "实习生", "职场竞争", "加班", "弹性办公", "自由职业", "知识付费", "短视频创业", "国货崛起", "新中式", "盲盒", "潮玩", "电竞", "亚运会", "奥运会", "世界杯", "英超", "欧冠", "NBA", "CBA", "中超", "网球", "滑雪", "冲浪", "潜水", "徒步", "自驾游", "出境游", "免签", "留学", "托福", "雅思", "考公", "事业编", "法考", "社保", "医保", "个人所得税", "消费券", "存款利率", "通货膨胀", "降准"] 
